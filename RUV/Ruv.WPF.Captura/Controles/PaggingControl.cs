...
namespace Ruv.WPF.Captura.Controles
{
    ...
    public class PaggingControl : Control
    {
        ...
        public IDataSourceBase PageContract
        {
            get
            {
                return GetValue(PageContractProperty) as IDataSourceBase;
            }
            set
            {
        ...
        static PaggingControl()
        {
            ...
            PageContractProperty = DependencyProperty.Register("PageContract", typeof(IDataSourceBase), typeof(PaggingControl));
        ...
        public void Navigate(PageChanges change)
        {
            ...
            if (PageContract == null || PageSizes == null || PageSizes.Count == 0)
            {
                return;
            }

            totalRecords = (uint)PageContract.VirtualItemCount();
            if (cmbPageSizes.SelectedItem != null)
                newPageSize = (uint)cmbPageSizes.SelectedItem;
            else
                newPageSize = PageSizes.First();
            ...
            ICollection<object> fetchData = PageContract.GetData((int)newPage, (int)newPageSize);
        ...
        public void SetPagerEnabled(bool enable) {
            this.btnFirstPage.IsEnabled = enable;
            this.btnLastPage.IsEnabled = enable;
            this.btnPreviousPage.IsEnabled = enable;
            this.btnNextPage.IsEnabled = enable;
            this.cmbPageSizes.IsEnabled = enable;
        }
