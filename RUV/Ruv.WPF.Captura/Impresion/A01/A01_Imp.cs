...
{
  /// <summary>
  /// Contiene la lógica de impersión para el Anexo 01.
  /// </summary>
    public class A01_Imp : ILogicaImpresion
    {
        #region CONSTRUCTOR
        ...
        /// </summary>
        int ElementoLista;
        Ruv.Infrastructure.Crosscutting.Common.Entidades.clsAnexo01 Entidad;
        IEnumerable<clsAnexo01_Victima> ListaVictimas;
        ...
        {
            Entidad = (fuenteDatos as clsAnexo01);
            ...
            switch ((ePasosImpresion)PasoActual)
            {
                ...
                case ePasosImpresion.DetalleTablaVictimas:
                    ...
                    else if (ElementoLista < ListaVictimas.Count())
                    {
                        ...
                        Resultado.ObjetoCuerpo = new A01_Detalle01();
        ...
        public object ObtenerBloque(int numeroEncabezado)
        {
            ...
            {
                case 0:
                    return new A01_Encabezado00() { DataContext = Entidad };
                case 1:
                    return new A01_Encabezado01() { DataContext = Entidad };
                case 2:
                    return new A01_Encabezado02() { DataContext = Entidad };
            }
            return null;
        }
        ...
        public void PasarPagina()
        {
            ...
            Resultado.Encabezados.Add(new A01_Encabezado00());
        }
