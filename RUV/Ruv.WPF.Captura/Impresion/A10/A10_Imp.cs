...
namespace Ruv.WPF.Captura.Impresion
{
  ...
  /// </summary>
  public class A10_Imp : ILogicaImpresion
  {
    #region CONSTRUCTOR
    ...
    /// </summary>
    int ElementoLista;
    Ruv.Infrastructure.Crosscutting.Common.Entidades.clsAnexo10 Entidad;
    IEnumerable<clsAnexo10_Victima> ListaVictimas;
    ...
    {
      Entidad = (fuenteDatos as clsAnexo10);
    ...
    public object ObtenerBloque(int numeroEncabezado)
    {
      switch (numeroEncabezado)
      {
        case 0:
          // Titulo Anexo
          return new A10_Encabezado00() { DataContext = Entidad };
        case 1:
          // Pregunta 1 a 7
          return new A10_Encabezado01() { DataContext = Entidad };
        case 2:
          // Encabezado pregunta 8 a 13
          return new A10_Encabezado02() { DataContext = Entidad };
        case 3:
          // Detalle pregunta 8 a 13
          return new A10_Detalle01();
      }
      return null;
    }
