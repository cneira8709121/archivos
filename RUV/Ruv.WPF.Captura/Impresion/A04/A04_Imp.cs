...
namespace Ruv.WPF.Captura.Impresion
{
  ...
  /// </summary>
  public class A04_Imp : ILogicaImpresion
  {
    #region CONSTRUCTOR
    ...
    /// </summary>
    int ElementoLista;
    Ruv.Infrastructure.Crosscutting.Common.Entidades.clsAnexo04 Entidad;
    IEnumerable<clsAnexo04_Victima> ListaVictimas;
    ...
    {
      Entidad = (fuenteDatos as clsAnexo04);
    ...
    public object ObtenerBloque(int numeroEncabezado)
    {
      switch (numeroEncabezado)
      {
        case 0:
          // Titulo Anexo
          return new A04_Encabezado00() { DataContext = Entidad };
        case 1:
          // Pregunta 1 a 7
          return new A04_Encabezado01() { DataContext = Entidad };
        case 2:
          // Encabezado pregunta 8 a 13
          return new A04_Encabezado02() { DataContext = Entidad };
        case 3:
          // Detalle pregunta 8 a 13
          return new A04_Detalle01();
      }
      return null;
    }
