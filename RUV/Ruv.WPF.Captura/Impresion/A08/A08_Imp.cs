...
namespace Ruv.WPF.Captura.Impresion
{
  ...
  /// </summary>
  public class A08_Imp : ILogicaImpresion
  {
    #region CONSTRUCTOR
    ...
    /// </summary>
    int ElementoLista;
    Ruv.Infrastructure.Crosscutting.Common.Entidades.clsAnexo08 Entidad;
    IEnumerable<clsAnexo08_Victima> ListaVictimas;
    ...
    {
      Entidad = (fuenteDatos as clsAnexo08);
    ...
    public object ObtenerBloque(int numeroEncabezado)
    {
      switch (numeroEncabezado)
      {
        case 0:
          // Titulo Anexo
          return new A08_Encabezado00() { DataContext = Entidad };
        case 1:
          // Pregunta 1 a 7
          return new A08_Encabezado01() { DataContext = Entidad };
        case 2:
          // Encabezado pregunta 8 a 13
          return new A08_Encabezado02() { DataContext = Entidad };
        case 3:
          // Detalle pregunta 8 a 13
          return new A08_Detalle01();
      }
      return null;
    }
