<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" Inherits="Notificaciones_NotificacionDetalle" Codebehind="NotificacionDetalle.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource" runat="server" TypeName="Ruv.WebApp.DataSources.Notificaciones.DataSourceNotificacionDetalle" EnablePaging="false" SelectMethod="DetalleData"  OnObjectCreated="ObjectDataSource_ObjectCreated" UpdateMethod="AprobarNotificacion"></asp:ObjectDataSource>
