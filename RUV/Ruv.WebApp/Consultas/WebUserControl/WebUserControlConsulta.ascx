<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="Consultas_WebUserControl_WebUserControlConsulta" CodeBehind="WebUserControlConsulta.ascx.cs" %>
<%@ Register Src="~/Utilidades/Controles/WebUserControl1.ascx" TagPrefix="ruv" TagName="WebUserControl1" %>
