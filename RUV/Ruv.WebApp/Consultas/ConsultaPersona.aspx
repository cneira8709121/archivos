<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="Ruv.WebApp.Presentation.Consultas.ConsultaPersona" CodeBehind="ConsultaPersona.aspx.cs" %>

<%@ MasterType VirtualPath="~/Site.Master" %>
<%--<%@ Register Src="~/Consultas/WebUserControl/WebUserControlConsulta.ascx" TagPrefix="ruv" TagName="ConsultaAdmin" %>--%>
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="PanelConsulta" Visible="false" runat="server" Width="100%">
                            ...
                            <asp:ObjectDataSource ID="OdsConsulta" runat="server" TypeName="DataSourceConsulta"
                                ...
                                SelectMethod="GetData" EnablePaging="true" OnObjectCreated="OdsConsulta_ObjectCreated"></asp:ObjectDataSource>
                        </asp:Panel>
                    </ContentTemplate>
                    <Triggers>
