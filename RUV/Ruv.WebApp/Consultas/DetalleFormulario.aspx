<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="Consultas_DetalleFormulario" CodeBehind="DetalleFormulario.aspx.cs" %>
            ...
            <tr>
                <td valign="top">
                    <table class="tblLeyenda" cellspacing="0">
                        ...
                        <tr>
                            <td>Radicación Pendiente por Verificar</td>
                            <td>Solicitud que se encuentra en trámite de verificación datos de distribución y 
                                        recepción del FUD
                            </td>
                            <tr>
                ...
                <td>
                    <asp:Repeater ID="HechosVictimizantesRepeater" runat="server" OnItemDataBound="HechosVictimizantesRepeater_ItemDataBound">
                        <ItemTemplate>
                            ...
                            <asp:GridView ID="GridViewDetalle" runat="server" AllowPaging="false" AutoGenerateColumns="False" SkinID="GridViewSinPaginacion" Width="100%">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CTipoVictima" HeaderText="Tipo Victima" />
                                </Columns>
                            </asp:GridView>
                        </ItemTemplate>
                    </asp:Repeater>
