<%@ Control Language="C#" AutoEventWireup="true" Inherits="Utilidades_Controles_Notificacion_ruvEdicionDireccionCorrespondencia" Codebehind="ruvEdicionDireccionCorrespondencia.ascx.cs" %>
