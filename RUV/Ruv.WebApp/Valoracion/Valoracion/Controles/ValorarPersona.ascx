<%@ Control Language="C#" AutoEventWireup="true" 
    Inherits="Valoracion_Valoracion_Controles_ValorarPersona" Codebehind="ValorarPersona.ascx.cs" %>
                ...
                <td align="left" colspan="2">
                    <asp:DetailsView ID="dvPersonaDetalle" runat="server" Width="100%" AutoGenerateRows="false">
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="¿Se Enmarca en Decreto Ley Étnico?">
                                <ItemTemplate>
                                    <ruv:DropDownList ID="ddlDecretoLey" runat="server" EsRequerido="false" Source="DecretoLey"
                                        IdCombo="ddlDecretoLey" AutoPostBack="false" SelectedValue='<%# Eval("DecretoLey") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText ="Este Hecho se Enmarca Dentro">
                                <ItemTemplate>
                                    <ruv:DropDownList ID="ddlHechoEnmarcado" runat="server" EsRequerido="false" Source="HechoEnmarcado"
                                        IdCombo="ddlHechoEnmarcado" AutoPostBack="false" SelectedValue='<%# Eval("HechoEnmarcadoId") %>'/>
                                </ItemTemplate>
                            </asp:TemplateField>
