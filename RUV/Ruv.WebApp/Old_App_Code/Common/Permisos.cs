...
public class Menus
{
    public List<Permisos> ObtenerPermisos()
    {
        ...
        //permisos.Add(new Permisos() { Id = "101206", Nombre = "Editar", Url = null, Tipo = 4, CausaValidacion = false, Padre = "1012", Imagen = "~/Utilidades/Imagenes/Editar.png", ClientScript = "EditarValoracionWPF();" });
        ...
        permisos.Add(new Permisos() { Id = "1054", Nombre = "ValorarEdicion", Url = string.Empty, Tipo = 1, CausaValidacion = false, Imagen = null });
        permisos.Add(new Permisos() { Id = "105401", Nombre = "ValorarEditar", Url = "/Valoracion/Valoracion/Nueva.aspx", Tipo = 2, CausaValidacion = false, Imagen = "~/Utilidades/Imagenes/Editar.png" });
        permisos.Add(new Permisos() { Id = "105402", Nombre = "Resumeneditar", Url = "/Valoracion/Valoracion/Resumen.aspx", Tipo = 2, Padre = "1054", CausaValidacion = false, Imagen = "~/Utilidades/Imagenes/Editar.png" });
        permisos.Add(new Permisos() { Id = "10540201", Nombre = "Atras", Url = null, Tipo = 3, CausaValidacion = false, Padre = "105402", Imagen = "~/Utilidades/Imagenes/Atras.png" });
        permisos.Add(new Permisos() { Id = "105403", Nombre = "Ver Declaración", Url = null, Tipo = 4, CausaValidacion = false, Padre = "1054", Imagen = "~/Utilidades/Imagenes/Descargar.png", ClientScript = "ShowModConsult()" });
        permisos.Add(new Permisos() { Id = "105404", Nombre = "Nuevo Hecho Victimizante", Url = null, Tipo = 4, CausaValidacion = false, Padre = "1054", Imagen = "~/Utilidades/Imagenes/Nuevo.png", ClientScript = "return ShowModConsult('mpopUpNHechoBehavior');", ServerCode = false });
        permisos.Add(new Permisos() { Id = "105407", Nombre = "Personas Asociadas a la Declaracion", Url = null, Tipo = 4, CausaValidacion = false, Padre = "1054", Imagen = "~/Utilidades/Imagenes/PersonasAsociadas.png", ClientScript = "", ServerCode = true });
        permisos.Add(new Permisos() { Id = "105405", Nombre = "Valores Actos Administrativos", Url = null, Tipo = 4, CausaValidacion = false, Padre = "1054", Imagen = "~/Utilidades/Imagenes/Editar.png", ClientScript = "return displayASPNETControl('mpopUpValoresAABehavior', function() { ruv.valoracion_valoresactos.initialize(); });", ServerCode = false });
        permisos.Add(new Permisos() { Id = "105401", Nombre = "Guardar", Url = null, Tipo = 4, CausaValidacion = false, Padre = "1054", Imagen = "~/Utilidades/Imagenes/Guardar.png", ClientScript = "ShowModConsult(null, 'Guardando Valoración')" });
        permisos.Add(new Permisos() { Id = "105402", Nombre = "Finalizar", Url = null, Tipo = 4, CausaValidacion = false, Padre = "1054", Imagen = "~/Utilidades/Imagenes/Finalizar.png", ClientScript = "return ShowModConsult('mpopGuardarBehavior')" });
        permisos.Add(new Permisos() { Id = "105406", Nombre = "Editar", Url = null, Tipo = 4, CausaValidacion = false, Padre = "1054", Imagen = "~/Utilidades/Imagenes/Editar.png", ClientScript = "EditarValoracionWPF();" });
        permisos.Add(new Permisos() { Id = "105404", Nombre = "Atras", Url = null, Tipo = 4, CausaValidacion = false, Padre = "1054", Imagen = "~/Utilidades/Imagenes/Atras.png" });
