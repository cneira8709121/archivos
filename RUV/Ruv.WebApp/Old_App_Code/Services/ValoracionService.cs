...
public class ValoracionService : IValoracionService
{
        ...
        using (DbTransaction transaction = Dao.InitTransaction())
        {
            try
            {
                ...
                if (valoracion.EstadoId == (int)eEstadosValoracion.NoValoradoDevuelto)
                {
                    ...
                    var devolucion = new clsDevolucion
                    {
                        NIdDeclaracion = valoracion.DeclaracionId
                                                       ,
    ...
    public bool FueraDeColombia(int declaracionId)
    {
        ValoracionesBusiness objValoracion = new ValoracionesBusiness();
        return objValoracion.EsFueraDeColombia(declaracionId);
    }
    ...
    {
        ValoracionesBusiness objValoracion = new ValoracionesBusiness();
        return objValoracion.GetHechoEnmarcado();
    }

    public List<clsDecretoLey> DecretoLey()
    {
        ValoracionesBusiness objValoracion = new ValoracionesBusiness();
        return objValoracion.GetDecretoLey();
    }
    ...
    public USUARIO_BASICO UsuarioPorId(int IdUsuario, ref string error)
    {
        Ruv.Business.General.UsuarioBusiness objUsuario = new Ruv.Business.General.UsuarioBusiness();
        return objUsuario.ObtenerUsuarioPorId(IdUsuario, ref error);
    }

    public clsConceptoDeclaracion ObtenerConceptoDeclaracion(int idDeclaracion)
    {
        ConceptoDeclaracionBusiness objConceptoDeclaracio = new ConceptoDeclaracionBusiness();
        return objConceptoDeclaracio.ObtenerConceptoDeclaracion(idDeclaracion);
    }

    public bool InsertaConceptoDeclaracion(clsConceptoDeclaracion conceptoDeclaracion)
    {
        ConceptoDeclaracionBusiness objConceptoDeclaracion = new ConceptoDeclaracionBusiness();
        return objConceptoDeclaracion.InsertaConceptoDeclaracion(conceptoDeclaracion);
    }
}
