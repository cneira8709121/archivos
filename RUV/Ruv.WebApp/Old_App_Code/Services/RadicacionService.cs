...
public class RadicacionService : IRadicacionService
{
    ...
    public com::LiderRadicacion.clsLiderRadicacion CargarDatos(long nIdDeclaracion, ref string cError)
	{
        ...
        byte[] bDocumentoRadActual = null;//objCritica.ObtenerImagenRadicacion(lRadicacion.RadActual.NId.Value, ref cNombreDocumentoRadActual, ref cError);
        ...
        if (lRadicacion.RadExistente != null && lRadicacion.RadExistente.NId.HasValue)
        {
            bDocumentoRadExistente = objCritica.ObtenerImagenRadicacion(lRadicacion.RadExistente.NId.Value, ref cNombreDocumentoRadExistente, ref cError);
        }
