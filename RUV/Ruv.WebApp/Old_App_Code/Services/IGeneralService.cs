...
public interface IGeneralService
{
    ...
    [OperationContract]
    List<clsPersonaIdentidad> ValidarIdentidad(int idTipoToma, int idUsuario, int idTipoDoc, string numDocumento, string primerNombre, string segundoNombre,
    ...
    [OperationContract]
    List<clsPersonaRNEC> BuscarPersonaRNEC(string numDocumento, int idTipoDoc);
}
