<%@ Page Title="Crear Consecutivo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="ActosAdmin_Nuevo" Codebehind="Nuevo.aspx.cs" %>
                    ...
                    <table width="50%" border="1" style="border-collapse: collapse; text-align: left">
                        ...
                        <tr class="dvRow">
                            <td class="dvHeader" style="width: 200px">
                                <asp:Label ID="lblOperacion" runat="server" Text="Operación" SkinID="lblBlanco"></asp:Label>
                            </td>
                            <td>
                                <ruv:DropDownList ID="ddlOperacion" runat="server" Valor="2168" Source="Parametros"
                                    OnSelectIndexChange="ddlOperacion_SelectIndexChange" AutoPostBack="true" EsRequerido="true" MensajeError="Seleccione el area" />
                            </td>
                        </tr>
                        <tr class="dvRow">
                            <td class="dvHeader" style="width: 200px">
                                <asp:Label ID="lblDocuemento" runat="server" Text="Documento" SkinID="lblBlanco"></asp:Label>
                            </td>
                            <td>
                                <ruv:DropDownList ID="ddlDocumento" runat="server" EsRequerido="true" MensajeError="Seleccione un documento" />
                            </td>
                        </tr>
                        <tr class="dvRow">
                            <td class="dvHeader" style="width: 200px">
