...
public class Varios
{
    ...
    public static int UsuarioId()
    {
        ...
        {
            clsUsuario _us = (clsUsuario)HttpContext.Current.Session[ConstantesSesion.USUARIO];
            usuarioId = _us.Id;
        }
        return usuarioId;
    }
    ...
    public static clsUsuario Usuario(HttpContext contexto)
    {
        clsUsuario usuario = new clsUsuario();
        if (contexto.Session[ConstantesSesion.USUARIO] != null)
        {
            usuario = (clsUsuario)contexto.Session[ConstantesSesion.USUARIO];
        }
        return usuario;
    }
    ...
    public static void CerrarCession(HttpContext _context)
    {
        ...
        if (RUV.Current != null && RUV.Current.Usuario != null && RUV.Current.Usuario.Cuenta != null && RUV.Current.Usuario.Contraseña != null)
            objLogin.CerrarSesion(RUV.Current.Usuario.Cuenta, RUV.Current.LlaveUsuario);
