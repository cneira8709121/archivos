...
public partial class ActosAdmin_Default : PaginaBase
{
    ...
    protected void Adfiltro_Filtro(object sender, FiltroEventArgs e)
    {
        ...
        {
            ActosAdminstrativos = ObjActosAd.ObtenerActosAdministrativosFiltro(filtropor.Nombre, e.Filtro.Texto1);
        }
        else
        {
            ActosAdminstrativos = ObjActosAd.ObtenerActosAdministrativosFiltro(filtropor.Nombre, "'" + e.Filtro.Fecha1.Value.ToString(ConfigurationManager.AppSettings["Fecha"]) + "' AND '" + e.Filtro.Fecha2.Value.ToString(ConfigurationManager.AppSettings["Fecha"]) + "'");
        }
