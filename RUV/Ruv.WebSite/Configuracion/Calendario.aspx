<%@ Page Title="Calendario de Festivos" Language="C#" AutoEventWireup="true" CodeFile="Calendario.aspx.cs" Inherits="Configuracion_Calendario" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:ObjectDataSource ID="odsFeriados" runat="server" SelectMethod="ObtenerNotificaciones" EnablePaging="false" TypeName="Ruv.WebSite.DataSources.Feriados.DataSourceFeriados" OnObjectCreated="odsFeriados_ObjectCreated"></asp:ObjectDataSource>
