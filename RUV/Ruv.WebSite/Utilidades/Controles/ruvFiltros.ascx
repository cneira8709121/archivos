<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ruvFiltros.ascx.cs" Inherits="Utilidades_Controles_dpsFiltros" %>
        ...
        <tr style="text-align:left">
            ...
            <td style="width:250px">
                <asp:DropDownList ID="ddlOrder" runat="server" Width="200px" 
                    ...
                    onselectedindexchanged="ddlOrder_SelectedIndexChanged" Visible="false" />
            </td>
            <td style="width:600px">
                &nbsp;</td>
            <td>
