<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ruvEdicionPuntoNotificacion.ascx.cs" Inherits="Utilidades_Controles_Notificacion_ruvEdicionPuntoNotificacion" %>
