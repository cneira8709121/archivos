<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ruvTextBox.ascx.cs"
    Inherits="Utilidades_Controles_dpsTextBox" %>
<asp:TextBox ID="txt" runat="server" OnTextChanged="txt_TextChanged" ValidationGroup="vgFiltro"></asp:TextBox>
<asp:RequiredFieldValidator ID="rv_txt" runat="server" ErrorMessage="El Campo es Requerido" ValidationGroup="vgFiltro"
