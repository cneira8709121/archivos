<%@ Page Title="Valorar" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="Nueva.aspx.cs" Inherits="Valoracion_Valoracion_Nueva" ValidateRequest="false" %>
...
<%--<asp:Content ID="Content1" ContentPlaceHolderID="Scripts" Runat="Server">
    ...
    <script type="text/javascript" src='<%= Page.ResolveClientUrl("~/JScripts/jquery.poshytip.js") %>'></script>
    <script type="text/javascript" src='<%= Page.ResolveClientUrl("~/JScripts/jUtils.js") %>'></script>
    <script type="text/javascript" src='<%= Page.ResolveClientUrl("~/JScripts/enhancedModals.js") %>' />
</asp:Content>--%>
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript" src='<%= Page.ResolveClientUrl("~/JScripts/Valoracion/JValorarPersona.js") %>'></script>
    <script type="text/javascript" src='<%= Page.ResolveClientUrl("~/JScripts/Valoracion/JValoresAA.js") %>'></script>
    <%--<script type="text/javascript" src='<%= Page.ResolveClientUrl("~/JScripts/Valoracion/JPuntosNotificacion.js") %>'></script>--%>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
                            ...
                            <asp:DetailsView ID="dvBasicaInfo2" runat="server" Width="100%" AutoGenerateRows="false">
                                <Fields>
                                    ...
                                    <asp:TemplateField HeaderText="Observación Valoración">
                                        <ItemTemplate>
                                            <%--<ruv:TextBox ID="txtObservacionValidacion" runat="server" TextMode="MultiLine" EsRequerido="false"
                                                Width="80%" Text='<%# Eval("Observacion") %>' Height="100px" />--%>
    ...
    <br />
    <%--<asp:Button ID="btnNuevoHecho" runat="server" Text="Nuevo Hecho Victimizante" OnClick="btnNuevoHecho_Click" />--%>
    <asp:UpdatePanel ID="upHecho" runat="server">
        <ContentTemplate>
    ...
    <%-- Fin - Valores AA--%>
    <%--Inicio - Puntos Notificacion--%>
<%--    <asp:UpdatePanel ID="upPuntosNotificacion" runat="server">
        <ContentTemplate>--%>
            <%-- ruv:PuntosNotificacion ID="puntosNotificacion" runat="server" /> --%>
<%--        </ContentTemplate>
    </asp:UpdatePanel>--%>
    <%-- Fin - Puntos Notificacion--%>
    <%--Inicio - Parte Motiva Se cambio para poder generar la parte motiva dependiendo del tipo de ad--%>
    <%--<table width="100%">
        <tr>
            <td colspan="2" style="width: 150px">
                <asp:Label ID="lblParteMotiva" runat="server" Text="Parte Motiva"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <ruv:TextBox ID="txtParteMotiva" runat="server" EsRequerido="false" TextMode="MultiLine"
