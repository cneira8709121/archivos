<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonasAsociadasVal.ascx.cs" Inherits="Valoracion_Valoracion_Controles_PersonasAsociadasVal" %>
<asp:Panel ID="pnlConsultaPersonasVal" runat="server" SkinID="PanelmodalPopup" ClientIDMode="Static">
    <div style="width: 740px">
        ...
        <asp:ObjectDataSource ID="odsPersonasAsociadas" runat="server" SelectCountMethod="CountAsociadosPersonaDeclaracion" SelectMethod="CargaAsociadosPersonaDeclaracion" EnablePaging="false" TypeName="Ruv.WebSite.DataSources.DataSourcePersonasAsociadasDeclaracion" OnObjectCreated="odsPersonasAsociadas_ObjectCreated"></asp:ObjectDataSource>
