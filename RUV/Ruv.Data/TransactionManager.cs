...
namespace Ruv.Data
{
	...
	public class TransactionManager : IDisposable
	{
        ...
        /// 
		public TransactionManager( string connectionString ) : this( connectionString, "System.Data.System.Data.OracleClient" )
		{
    	}

        public TransactionManager(Database basededatos)
        {
            this._database = basededatos;
            this._connection = this._database.CreateConnection();
        }
