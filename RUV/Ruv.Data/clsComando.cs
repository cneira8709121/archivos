...
namespace Ruv.Data
{
    public class clsComando : IDisposable
    {
        ...
        private clsConexion oConTransaccion;
        ...
        {
            oConTransaccion = new clsConexion();
        ...
        {
            OracleParameter P = new OracleParameter(nombre, OracleType.Cursor);
        ...
        {
            OracleParameter P = new OracleParameter(nombre, OracleType.Int32);
            P.Direction = ParameterDirection.Output;
            _Comando.Parameters.Add(P);
        ...
        {
            OracleParameter P = new OracleParameter(nombre, OracleType.VarChar);
            P.Direction = ParameterDirection.Output;
            P.Size = 3000;
            _Comando.Parameters.Add(P);
        ...
        public Database oDataBase
        {
            ...
            {
                if (_oDataBase == null)
                    _oDataBase = EnterpriseLibraryContainer.Current.GetInstance<Database>();
