...
{
    [DataContract]
    public partial class clsAnexo01 : clsEntidadBase, IDataErrorInfo, IAnexo, IValidationEntity
    {
        public clsAnexo01()
        {
            FechaYLugar = new clsAnexo_FechaYLugar();
            InformacionJefeGrupo = new clsAnexo_JefeDeGrupo();
            Victimas = new ObservableCollection<clsAnexo01_Victima>();
        ...
        private ObservableCollection<clsAnexo01_Victima> _Victimas;
        [DataMember]
        public ObservableCollection<clsAnexo01_Victima> Victimas
        {
        ...
        {
            get { return "1. Acto Terrorista / Atentados / Combates / Enfrentamientos / Hostigamientos"; }
        }
