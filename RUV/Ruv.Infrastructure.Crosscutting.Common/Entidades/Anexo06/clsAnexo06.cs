...
{
  [DataContract]
  public partial class clsAnexo06 : clsEntidadBase, IDataErrorInfo, IAnexo, IValidationEntity
  {
    public clsAnexo06()
    {
      FechaYLugar = new clsAnexo_FechaYLugar();
      InformacionJefeGrupo = new clsAnexo_JefeDeGrupo();
      Victimas = new ObservableCollection<clsAnexo06_Victima>();
    ...
    private ObservableCollection<clsAnexo06_Victima> _Victimas;
    [DataMember]
    public ObservableCollection<clsAnexo06_Victima> Victimas
    {
    ...
    {
      get { return "6. Homicidio - Masacre"; }
    }
