...
{
  [DataContract]
  public partial class clsAnexo08 : clsEntidadBase, IDataErrorInfo, IAnexo, IValidationEntity
  {
    public clsAnexo08()
    {
      Victimas = new ObservableCollection<clsAnexo08_Victima>();
    ...
    #region PREGUNTAS 8 A 14

    private ObservableCollection<clsAnexo08_Victima> _Victimas;
    [DataMember]
    public ObservableCollection<clsAnexo08_Victima> Victimas
    {
