...
namespace Ruv.Business.Captura.Anexos
{
    ...
    {
        public const int TipoAnexo = (int)Common.eTiposAnexo.Anexo02;

        #region Guardar
        public static void Guardar(clsAnexo02 anexoSiniestro, int idValoracion, DbTransaction tran)
        {
            int idValanexo = 0;
            ...
            if (idValanexo == 0) {
                ...
                Anexo02.ObtenervaloracionAnexo(anexoSiniestro, idValoracion,ref idValanexo, tran); 
            }
            ...
            //TBANEXO02
            foreach (clsAnexo02_Victima anexoView in anexoSiniestro.Victimas)
            {
                Anexo02.GuardarAnexo(anexoView, id_siniestro, idValanexo, tran);
        ...
        public static void ObtenervaloracionAnexo(clsAnexo02 anexoSiniestro, int idValoracion, ref int idValanexo, DbTransaction tran)
        {
        ...
        #region Siniestro
        private static void GuardarSiniestro(clsAnexo02 anexoSiniestro, int idValoracion, ref int idValanexo, DbTransaction tran)
        {
            entSiniestroPersona entBdSiniestro = new entSiniestroPersona();

            TBSINIESTROS_PERSONA siniestroData = new TBSINIESTROS_PERSONA();
            Anexo02.ParseViewToData_Siniestro(anexoSiniestro, siniestroData);
        ...
        private static void ParseViewToData_Siniestro(clsAnexo02 anexo, Ruv.Data.TBSINIESTROS_PERSONA siniestroData)
        {
        ...
        #region Anexo
        private static void GuardarAnexo(clsAnexo02_Victima anexoView, int id_siniestro, int idValanexo, DbTransaction tran)
        {
            TBANEXO2 anexoData = new TBANEXO2();
            Anexo02.ParseViewToData_Anexo(anexoView, id_siniestro, anexoData);
            entAnexo2 entBd = new entAnexo2();
            entSiniestroPersona entBdSiniestro = new entSiniestroPersona();
            ...
            switch (anexoView.EstadoRegistro)
            {
                case eEstadoRegistro.Insertar:
                    //Activar
                    anexoData.ACTIVO = 1;
                    entBd.setAnexo2(anexoData, tran);
                    ...
                    break;
                case eEstadoRegistro.Modificado:
                    entBd.updAnexo2(anexoData, tran);
                    break;
                case eEstadoRegistro.Eliminado:
                    //Desactivar
                    anexoData.ACTIVO = 0;
        ...
        public static void ParseViewToData_Anexo(clsAnexo02_Victima anexoView, int id_siniestro, TBANEXO2 anexoData)
        {
            ...
            anexoData.SOLICITA_PROTECCION = (anexoView.ProteccionHaSolicitado.HasValue) ? (short)anexoView.ProteccionHaSolicitado : Common.ShortNull;
            anexoData.PROTECCION = (anexoView.ProteccionLeHanBrindado.HasValue) ? (short)anexoView.ProteccionLeHanBrindado : Common.ShortNull;
            anexoData.TIPO_PROTECCION = anexoView.ProteccionTipoDeMedida;
            anexoData.ENTIDAD_PROTECCION = anexoView.ProteccionEntidad;
            anexoData.FECHA_PROTECCION = anexoView.ProteccionFechaInicial;
            anexoData.VIGENCIA_PROTECCION = anexoView.ProteccionVigencia;
            anexoData.CONTINUA_AMENAZAS = (anexoView.HaContinuadoConLasAmenzas.HasValue) ? (short)anexoView.HaContinuadoConLasAmenzas : Common.ShortNull;
            #endregion
        ...
        public static clsAnexo02 ObtenerAnexo(TBSINIESTROS_PERSONA siniestroData)
        {
            entAnexo2 entAnexo = new entAnexo2();
            clsAnexo02 anexoView = new clsAnexo02();

            //Pasar datos a la vista
            Anexo02.ParseDataToView_Siniestro(siniestroData, ref anexoView);

            //Reiniciar Estado
            anexoView.EstadoRegistro = eEstadoRegistro.SinModificaciones;

            //Obtener las personas del anexo
            List<TBANEXO2> anexosData = entAnexo.getData(siniestroData.ID);

            foreach (TBANEXO2 anexoData in anexosData)
            {

                clsAnexo02_Victima VictimaAnexoView = new clsAnexo02_Victima();

                Anexo02.ParseDataToView_Anexo(anexoData, VictimaAnexoView);
        ...
        public static void ParseDataToView_Siniestro(Ruv.Data.TBSINIESTROS_PERSONA siniestroData, ref clsAnexo02 anexoView)
        {
        ...
        public static void ParseDataToView_Anexo(TBANEXO2 anexoData, clsAnexo02_Victima anexoView)
        {
            #region Common Anexos
            ...
            #region Medidas de protección
            anexoView.ProteccionHaSolicitado = anexoData.SOLICITA_PROTECCION;
            anexoView.ProteccionLeHanBrindado = anexoData.PROTECCION;
            anexoView.ProteccionTipoDeMedida = anexoData.TIPO_PROTECCION;
            anexoView.ProteccionEntidad = anexoData.ENTIDAD_PROTECCION;
            anexoView.ProteccionFechaInicial = anexoData.FECHA_PROTECCION;
            anexoView.ProteccionVigencia = anexoData.VIGENCIA_PROTECCION;
            anexoView.HaContinuadoConLasAmenzas = anexoData.CONTINUA_AMENAZAS;
            #endregion
